...
Get-AzEventHubNamespace -ResourceGroup $resourcegroup1 –NamespaceName $primarynamespace
...
Set-AzEventHubGeoDRConfigurationFailOver -ResourceGroup $resourceGroup2 -Name $aliasname -Namespace $secondarynamespace
